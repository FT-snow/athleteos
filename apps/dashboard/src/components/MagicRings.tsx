...
export default function MagicRings({
  ...
  useEffect(() => {
    ...
    const animate = (t: number) => {
      ...
      uniforms.uColor.value.set(p.color ?? '#79BBC3');
      uniforms.uColorTwo.value.set(p.colorTwo ?? '#A1D7D6');
      ...
      uniforms.uMouseInfluence.value = (p.followMouse ?? false) ? (p.mouseInfluence ?? 0.2) : 0;
      ...
      uniforms.uBurst.value = (p.clickBurst ?? false) ? burstRef.current : 0;
